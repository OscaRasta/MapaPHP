...
<html>
  <head>
    ...
    <script type="text/javascript" src="https://maps.google.com/maps/api/js?key=AIzaSyCF2DMb0-VBwgPZdeFUl5xqp4opHekhJsw"></script>
...
function handleNoGeolocation(errorFlag)
{
	  ...
	  var options = {
		map: map,
		position: new google.maps.LatLng(13.481339870158163, -88.18377166986465),
		content: content
	  };
